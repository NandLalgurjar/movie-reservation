                    ...
                    <div className="navbar-collapse w-100 collapse" id="navbarCollapse">
                        <ul className="navbar-nav navbar-nav-scroll me-auto">
                            <li className="nav-item dropdown dropdown-menu-shadow-stacked">
                                <a className="nav-link bg-primary bg-opacity-10 rounded-3 text-primary px-3 py-3 py-xl-0" href="#" id="categoryMenu" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i className="bi bi-ui-radios-grid me-2"></i>
                                        ...
                                        <div className="dropdown-menu dropdown-menu-start dropdown-width-lg" data-bs-popper="none">
                                            ...
                                            <div className="row">
                                                <div className="col-12">
                                                    <div className="card bg-blue rounded-0 rounded-bottom p-3 position-relative overflow-hidden" style={{ background: "url(assets/images/pattern/05.png) no-repeat center center", "background-size": "cover" }}>
                                        ...
                                        <div className="col-xl-6 col-xxl-3">
                                            ...
                                            <div className="row g-2 justify-content-center mt-3">
                                                ...
                                                <div className="col-6 col-sm-4 col-xxl-6">
                                                    <a href="#">
                                                        <img src="assets/images/client/google-play.svg" className="btn-transition" alt="google-store" />
                                                    </a>
                                                </div>

                                                <div className="col-6 col-sm-4 col-xxl-6">
                                                    <a href="#">
                                                        <img src="assets/images/client/app-store.svg" className="btn-transition" alt="app-store" />
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
