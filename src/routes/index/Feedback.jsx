                ...
                <div className="row g-4 g-lg-5 align-items-center">
                        ...
                        <div className="row mt-0 mt-xl-5">
                            ...
                            <div className="col-md-7 position-relative mb-0 mt-0 mt-md-5">
                                ...
                                <div className="bg-body shadow text-center p-4 rounded-3 position-relative mb-5 mb-md-0">
                                    ...
                                    <blockquote>
                                        <p>
                                            <span className="me-1 small"><i className="fas fa-quote-left"></i></span> Moonlight newspaper up its enjoyment agreeable depending. Timed voice share led him to widen noisy young. At weddings believed laughing
                        ...
                        <div className="row mt-5 mt-xl-0">
                            ...
                            <div className="col-md-5 mt-n6 mb-0 mb-md-5">
                                <div className="bg-body shadow text-center p-4 rounded-3">
                                    ...
                                    <blockquote>
                                        <p>
                                            <span className="me-1 small"><i className="fas fa-quote-left"></i></span> At weddings believed laughing although the Moonlight newspaper up its enjoyment agreeable depending.
                                            <span className="ms-1 small"><i className="fas fa-quote-right"></i></span>
                                        </p>
                                    </blockquote>
                                    {/* <!-- Rating --> */}
                    ...
                    <div className="col-xl-5 order-1 text-center text-xl-start">
                        ...
                        <p>Supposing so be resolving breakfast am or perfectly. It drew a hill from me. Valley by oh twenty direct me so. Departure defective arranging rapturous did believe him all had supported. Family months lasted simple set nature vulgar
                            him. Picture for attempt joy excited ten carried manners talking how.</p>
